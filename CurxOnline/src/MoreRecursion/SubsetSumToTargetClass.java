...
public class SubsetSumToTargetClass {
	...
	public static void main(String[] args) {
		...
		int count = SplitArrayInTwoWithEqualSumCount(arr,0,target,0,exclude_indice_list,include_indice_list);
		System.out.println(count);
		SplitArrayInTwoWithEqualSum(arr,0,target,0,exclude_indice_list,include_indice_list);
